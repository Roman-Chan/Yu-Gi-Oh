...
function Modal({ character, handleCloseModal }) {
  ...
  <div className="bg-gray-900 rounded-xl shadow-2xl sm:w-11/12 mx-10 h-screen overflow-y-scroll">
          <div className="px-6 py-8 mx-auto">
            <div className="lg:mx-6 lg:flex lg:items-center ">
              ...
              <div style={{ backgroundColor: "rgb(178, 88, 25)" }} className="rounded-xl p-4">
                  <p className="text-white text-lg font-semibold dark:text-white">
                    Nombre:
                  </p>
                  <p className="text font-semibold text-white">{character.name}</p>
                </div>
                <div style={{ backgroundColor: "rgb(178, 88, 25)" }} className="rounded-xl p-4">
                  <p className="text-white text-lg font-semibold dark:text-white">
                    Tipo:
                ...
                <div style={{ backgroundColor: "rgb(178, 88, 25)" }} className="rounded-xl p-4">
                  <p className="text-white text-lg font-semibold dark:text-white">
                    ...
                    <p className="text font-semibold text-white">{character.card_sets[0].set_price}</p>
            </div>
          </div>
        </div>
        <div className="mt-6">
